About conda-prefix-replacement
==============================
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8085&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/conda-prefix-replacement-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `conda-prefix-replacement` can be installed with:

```
conda install conda-prefix-replacement
```

It is possible to list all of the versions of `conda-prefix-replacement` available on your platform with:
